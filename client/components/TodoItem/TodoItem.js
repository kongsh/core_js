...
// <style>@import url('./components/TodoList/TodoItem.css');</style>
...
export class TodoItem extends HTMLElement {
  ...
  handleToggleChecked() {
    if (this.checkbox.checked) this.contentInput.classList.add('done');
    else this.contentInput.classList.remove('done');
